...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.huawei.hms.flutter.ads.HmsAdsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin huawei_ads, com.huawei.hms.flutter.ads.HmsAdsPlugin", e);
    }
    try {
